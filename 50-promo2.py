...
def executar_codigo():
    ...
    for i in range(numero_de_vezes_que_vai_repetir):
        ...
        detectar_e_clicar('./whats-puro.png', 11, ajuste_x=0, ajuste_y=0)
        ...
        # pyautogui.write("9af341a13ba90e7d7d21f1b91225d003") 
            ...
            time.sleep(0.1)
            pyautogui.write('Relembrando que a nossa SALE ainda está rolando e agora com estoque limitado!')
            pressionar_e_esperar('enter', 1)
