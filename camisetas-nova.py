...
def executar_codigo():
    ...
    for i in range(numero_de_vezes_que_vai_repetir):
        ...
        detectar_e_clicar('./enviar-mens.jpg', 1, ajuste_x=0, ajuste_y=0)
        
        pyautogui.click(627, 326)
        pyautogui.hotkey('ctrl', 'a')
        pyautogui.hotkey('ctrl', 'c')
        mensagem = pyperclip.paste()
        detectar_e_clicar('./enviar-whats.jpg', 0.8, ajuste_x=0, ajuste_y=0)
        # return
        ...
        # texto_modificado_url = 'wa.me/47997676797'        
        ...
        if invalido:
            ...
            clicar_e_esperar(503, 734, 1)
            # clicar_e_esperar(488, 527, 3)
            pyautogui.click(488, 527)
            pyautogui.click(488, 527)
            time.sleep(0.5)
            pyautogui.click(488, 527)
            time.sleep(3.5)
            pyautogui.write("dd31120cfab3ab4b25c79e2c2851706f")
